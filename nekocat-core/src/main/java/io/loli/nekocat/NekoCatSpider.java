...
public class NekoCatSpider {
    ...
    public NekoCatSpider(String startUrl, String name, PublishSubject<NekoCatRequest> source, List<NekoCatProperties> consumers, NekoCatDownloader downloader, List<NekoCatInterceptor> interceptors) {
    ...
    public void start() {
        ...
        subscribeResult = source.subscribe(request -> {
            if (stop) {
